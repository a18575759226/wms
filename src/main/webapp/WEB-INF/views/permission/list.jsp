        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <input type="button" value="加载权限1" class="ui_input_btn01 btn_reload"
                               data-url="/permission_reload.action"/>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <s:iterator value="#result.listData">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:;" class="bth_delete"

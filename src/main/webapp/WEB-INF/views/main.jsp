...
<div id="side">
    ...
    <div id="left_menu_cnt">
        ...
        <div id="nav_resource">
            &lt;%&ndash;<ul id="dleft_tab1" class="ztree"></ul>&ndash;%&gt;
            <ul id="dleft_tab1" class="ztree">
                ...
                <li><a href="javascript:;" data-action="/systemmenu.action">系统管理</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div id="main">
    <iframe name="right" id="rightMain" src="/employee.action" frameborder="no" scrolling="auto" width="100%"
